...
This file states a direct CP/Kraus corollary of Kadison–Schwarz for normal
...
* `KadisonSchwarz.schwarz_inequality_normal_operator`: Wolf Proposition 5.1 for positive maps
...
/-- Wolf Proposition 5.1: Schwarz inequality for normal operators under positive maps.

The proof is delegated to the commutative-domain construction in
...
Wolf Proposition 1.6 there, and then reads the result as a Loewner-order inequality. -/
