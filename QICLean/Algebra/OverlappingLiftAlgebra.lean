...
This file records the multiplicative, star-preserving, additive,
support-annihilation, and positivity properties of the natural lifts from two
adjacent tensor factors to three tensor factors.
-/
...
theorem posSemidef_of_leftOverlappingLift_posSemidef
  ...
  have hPrincipalEq :
    ...
    simp
  simpa only [hPrincipalEq] using hPrincipal
