...
\cite[pp.~523--524]{Yamagami1993Cyclic}.  The accompanying definitions retain
Yamagami's forward window and provide the explicit index-negation bridge to
the backward Choi window.  This is not the cyclic reciprocal inequality: the
