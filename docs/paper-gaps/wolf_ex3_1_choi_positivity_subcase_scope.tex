...
\end{align}
with the usual zero-term convention; the cases $n=1$ and $n=d-2$ are done,
as is $n=d-1$, which lies outside the source's range.  Once this estimate is
...
new proof.  This is tracked by \href{https://github.com/LionSR/QICLean/issues/19}{QICLean issue \#19}.  The indecomposability
...
the $n=1$ and $n=d-2$ positive-map families, but they should not be cited as
the formalization of Wolf's full Choi-type positivity theorem, whose range is
$1\le n\le d-2$.
