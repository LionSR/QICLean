...
`QICLean/Analysis/EntropyMarkovReverse.lean`, and the biconditional combines the
...
`QICLean/Analysis/OperatorConvexity.lean`. The `QICLean/Axioms/` directory held
