...
QICLean also permits a narrow repository-local exception for exact pass-through
...
- all non-Archive uses in QICLean have been migrated or were already absent, and
