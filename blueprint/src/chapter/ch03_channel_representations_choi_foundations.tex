...
% A tensor-network diagram for \tau=(T\otimes\id)(\ketbra{\Omega}{\Omega})
% accompanied this formula in TNLean (Wolf, Proposition 2.1, Equation (2.1)).
% QICLean does not carry the tenkz diagram pipeline; the equation above is
% the complete statement. See interface_edges.md / the packaging report.
