...
For a positive semidefinite matrix $P$, Wolf introduces the face $C(P)$ in the
...
formalize this face-dimension step only, not the full equivalence in
Proposition~3.6.

\begin{definition}[The face $C(P)$ of the positive semidefinite cone]
...
\begin{theorem}[Span of the face $C(P)$]
...
\begin{corollary}[Dimension of the face span]
