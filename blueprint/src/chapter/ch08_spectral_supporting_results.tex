...
\begin{theorem}[Spectral-radius criterion from eigenvalue bounds]
    ...
    Let $V$ be a nonzero finite-dimensional complex normed space. If every
    eigenvalue of an endomorphism $F:V\to V$ satisfies $|\lambda|<1$, then the
    spectral radius of $F$ is strictly less than $1$.
\end{theorem}
