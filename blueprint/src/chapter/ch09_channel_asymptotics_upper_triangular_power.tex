...
% Equation (8.111).  The generic unitary Schur triangularization is now
% formalized above.  The channel-level estimate tracked in QICLean issue #300
% remains pending on its specialization and the source's bound on the strictly
