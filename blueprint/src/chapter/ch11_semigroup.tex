...
\input{chapter/ch11_semigroup_dynamics_and_gksl}
\input{chapter/ch11_semigroup_dissipation_and_primitivity}
\input{chapter/ch11_semigroup_adjoint_kernel_and_reducibility}
