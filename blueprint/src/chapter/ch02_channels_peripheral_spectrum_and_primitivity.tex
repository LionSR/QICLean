...
\begin{remark}\label{rem:adjoint_fp_more_general}\leanok
    ...
    In the same adjoint-fixed-point formulation,
    Section~\ref{sec:peripheral_refinements} proves the corresponding cyclic
    structure: the cyclic group of peripheral eigenvalues is
    Theorem~\ref{thm:peripheral_cyclic_structure}, and the cyclic projection
    decomposition is
