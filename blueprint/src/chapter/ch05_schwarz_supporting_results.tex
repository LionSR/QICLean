\section{Schwarz Inequalities and Multiplicative Domains}
\label{ch:schwarz_supporting_results}
This section collects the elementary order, trace-duality, rank-one, and
weighted-trace arguments used earlier in this chapter.
