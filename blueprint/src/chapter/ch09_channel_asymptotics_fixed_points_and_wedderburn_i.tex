...
We first record the matrix-product-tensor form of corner invariance; the
channel-level argument below uses its Kraus analogue.
...
\begin{proof}
    ...
    Theorem~\ref{thm:kraus_lower_zero_invariant_compression}.
\end{proof}
