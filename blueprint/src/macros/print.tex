...
% The web renderer gives sibling tenkz pictures a non-wrapping flex row.
% Print keeps the exact centered layout used before the web-only wrapper.
...
\newcommand{\tnleanDocHome}{https://lionsr.github.io/QICLean/docs}
